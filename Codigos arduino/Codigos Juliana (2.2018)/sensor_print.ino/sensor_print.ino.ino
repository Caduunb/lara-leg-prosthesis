...
/**zeroing functions are inside imu and encoder libraries**/
/* Imax = 1.333A @ 8V -> 255
...
void loop()
{
  ...
  if(IMU_MODE & ACCEL_MODE) //read --> foi retirada da camada mais baixa porque so usar 'rleg.IMU->read' nao funcionava. nao se sabe porque. 
  {
